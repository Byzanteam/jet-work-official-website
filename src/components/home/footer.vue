<template>
  <footer class="bg-gray-08">
    <div class="py-10 xl:py-14 content-container">
      <div
      ...
      >
        ...
        <div
          class="text-gray-80 text-sm font-medium mt-[34px] xl:mt-0 text-center xl:text-left"
        >
          <div>
          ...
          <div class="xl:flex">
            ...
            <!-- TODO: use i18n -->
            <div class="text-gray-50 xl:text-gray-80 xl:ml-2 mt-2">
              蜀ICP备15017503号-2
            </div>
          </div>
        </div>
